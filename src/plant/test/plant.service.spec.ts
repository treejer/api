...
describe("App e2e", () => {
  ...
  it("updateTree", async () => {
    ...
    const treeSpecs2JSON: string = "treeSpecs 2JSON";
    ...
    jest.spyOn(graphService, "getTreeData").mockReturnValue(
      Promise.resolve({
        ...
        planter: account1.address,
        treeStatus: "4",
        plantDate: Math.floor(new Date().getTime() / 1000).toString(),
      })
    );
  ...
  it("get assigned plant requests id list", async () => {
    ...
    let result = await plantService.getAssignedTreeRequestsJustId(
      { status: PlantStatus.PENDING, signer: account1 },
      {}
    );
  ...
  it("get update requests id list", async () => {
    let account1 = "0x5783AfB718C79e2303584BA798849D35A3739461";
    let account2 = "0xddD9F49481e2b8Bea35407A69CBB88C301128FA1";
    let account = await web3.eth.accounts.create();
    ...
    let result = await plantService.getUpdateTreeRequestsJustId(
      { status: PlantStatus.PENDING, signer: account1 },
      {}
    );
  ...
  // it("get plant requests with limit", async () => {
  //   let account1 = "0x5783AfB718C79e2303584BA798849D35A3739461";
  //   let account2 = "0xddD9F49481e2b8Bea35407A69CBB88C301128FA1";
  //   let account = await web3.eth.accounts.create();
  ...
  //   expect(result2.data.length).toBe(3);
  ...
  //     if (index < account1Nonces.length) {
  //       expect(result3.data[index].signer).toBe(account1);
  //       expect(result3.data[index].nonce).toBe(account1Nonces[index]);
  //     } else {
  //       expect(result3.data[index].signer).toBe(account2);
  //       expect(result3.data[index].nonce).toBe(
  //         account2Nonces[index - account1Nonces.length]
  //       );
  //     }

  //     expect(result3.data[index].status).toBe(PlantStatus.PENDING);
  //   }
  // });

  // it("get assigned requests with limit", async () => {
  //   let account1 = "0x5783AfB718C79e2303584BA798849D35A3739461";
  //   let account2 = "0xddD9F49481e2b8Bea35407A69CBB88C301128FA1";
  //   let account = await web3.eth.accounts.create();
  ...
  //   }
  // });
  // it("get update requests with limit", async () => {
  //   let account1 = "0x5783AfB718C79e2303584BA798849D35A3739461";
  //   let account2 = "0xddD9F49481e2b8Bea35407A69CBB88C301128FA1";
  //   let account = await web3.eth.accounts.create();
